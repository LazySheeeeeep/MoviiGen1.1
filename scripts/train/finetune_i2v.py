...
from scripts.dataset.latent_datasets import LatentDataset, i2v_latent_collate_function
...
def process_batch(
    ...
    latents, encoder_hidden_states, latent_attn_mask, prompt_attention_mask, y, a_attn_mask, clip_fea = [
...
def main(args):
    ...
    train_dataloader = DataLoader(
        ...
        batch_size=args.train_batch_size,
        sampler=sampler,
        collate_fn=i2v_latent_collate_function,
        pin_memory=True,
